...
<br />
    ...
    <div class="container">
        <div class="row">
            <h1 class="title-heading ml-3 pt-3">Nos partenaires</h1>
        </div> <!-- ./row -->   
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                ...
                <ul>
                    <li>&ndash; Golfe du Morbihan Vannes Agglomération</li>
...
<hr>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                ...
                <p>La politique territoriale, à travers des contrats de partenariat, permet le croisement des priorités locales et des orientations régionales en accompagnant des projets mettant en œuvre des stratégies de territoire.</p>
                <p>Les projets soutenus dans le cadre de la politique territoriale s'inscrivent dans une démarche qualitative. Ainsi la région est particulièrement attentive aux aspects qualitatifs suivants:</p>
                <ul>
                    <li>&bull; qualité du lien social</li>
                    <li>&bull; développement des langues régionales, de l'art et la culture</li>
                    <li>&bull; impact environnemental</li>
                    <li>&bull; qualité de l'emploi</li>
                    <li>&bull; égalité femmes-hommes.</li>
                </ul> 
                
                <a href="https://www.bretagne.bzh/jcms/l_22662/fr/promouvoir-une-economie-sociale-et-solidaire">www.bretagne.bzh</a>
...
<hr>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-4">
                ...
                <p>GMVA a signé une convention avec le Conseil régional de Bretagne avec notamment comme priorité transversale la valorisation des ressources du territoire pour diversifier les activités et les emplois, renforcer l’attractivité et accompagner les transitions économiques. Elle met également l'accent sur les axes de travail suivants:</p>
                <ul>
...
<hr>
        ...
        <div class="row">
            <div class="col-md-12 mt-4">
                <p>La Cress Bretagne a été créée il y a une vingtaine d'années sur l'initiative de réseaux régionaux de l'économie sociale et solidaire bretonne. Ces derniers lui ont confié des missions de promotion et de développement de l'ESS, en complémentarité et en synergie avec leurs propres actions. Fortement engagée dans l'émergence de l'inter-réseau des Cress (au Conseil National des Cres), elle contribue au développement des synergies inter-régionales entre réseaux de l'ESS.</p>
            <div class="col">
                <h4>&rarr; Des actions et des missions confiées par les réseaux de l'ESS</h4>
            </div>
            <div class="col">
                <h5>Les représenter,</h5>
                <p>sur les sujets transversaux à l'ESS, aussi bien auprès des pouvoirs publics que des acteurs socio-économiques pour développer, améliorer les politiques publiques en direction des acteurs de l'ESS et faire en sorte qu'ils soient mieux pris en compte dans l'action publique en général.</p>
            </div>

            <div class="col">
                <h5>Appuyer la création et le développement des entreprises de l'ESS,</h5>
                <p>en mettant en œuvre des actions de communication afin de faire connaître l'ESS auprès du plus grand nombre.</p>
            </div>

            <div class="col">
                <h5>Promouvoir l'ESS,</h5>
                <p>en coordonnant acteurs de l'ESS et pouvoirs publics pour imaginer et mettre en œuvre des dispositifs et outils de soutien à la création d'activité et au développement des entreprises de l'ESS;</p>
                <p>en initiant et développant des coopérations entre les réseaux et entre les entreprises de l'ESS..</p>
            </div>

            <div class="col">
                <h5>Développer la formation des dirigeants et des salariés de l'ESS,</h5>
                <p>en animant des temps de rencontres et d'échanges de pratiques et de compétences.</p>
            </div>
...
<hr>
        ...
        <div class="row">
            <div class="col-md-12 mt-4">
                <p>La Direccte est l’interlocuteur économique et social de l’État en région des entreprises et des acteurs socio-économiques.</p>
                <p>Au travers de 3 pôles et 4 unités territoriales dans les départements, elle œuvre:</p>
                <ul>
                    <li>&bull; à la préservation et au développement du tissu économique et social, </li>
                    <li>&bull; au renforcement de la compétitivité des entreprises,</li>
                    <li>&bull; à la valorisation des ressources humaines,</li>
                    <li>&bull; à l’insertion professionnelle des demandeurs d’emploi,</li>
                    <li>&bull; à l’amélioration des conditions de travail et du dialogue social,</li>
